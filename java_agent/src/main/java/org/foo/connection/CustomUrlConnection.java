 ...
 * @since 1.0
 */
public abstract class CustomerUrlConnection {
     ...
     */
    protected CustomURLConnection(CustomURL url) {
        this.url = url;
        if (url == null) {
     ...
     *
     * @implSpec The default implementation of this method returns an empty map
     *           always.
     *
     ...
     * header field as special, in which case, {@link #getHeaderField(int)
     * getHeaderField(0)}
     * may return some value, but {@code getHeaderFieldKey(0)} returns {@code null}.
     * For {@code n > 0 } it returns {@code null} if there are fewer than
     * {@code n+1} fields.
     *
     ...
     *                     requires network or file I/O and an exception occurs
     *                     while
     *                     computing it.
     */
     ...
     * @param defaultVal whether caching is enabled by default for the given
     *                   protocol
     * @since 9
     */
    ...
    /**
     * Returns the default value of the {@code useCaches} flag for the given
     * protocol. If
     * {@link #setDefaultUseCaches(String,boolean)} was called for the given
     * protocol,
     * then that value is returned. Otherwise, if
     * {@link #setDefaultUseCaches(boolean)}
     ...
     * @return the default value of the {@code useCaches} flag for the given
     *         protocol.
     * @since 9
     */
     ...
     * multiple values are added for a given key. The values are returned in the
     * order they
     * were added.
     *
