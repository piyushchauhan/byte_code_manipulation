 ...
 *          The {@link Path#of(URI)} factory method and the
 *          {@link File#File(URI)}
 *          constructor can be used to create {@link Path} or {@link File}
 *          objects from a file URI. {@link Path#toUri()} and
 *          {@link File#toURI()}
 ...
 *          {@linkplain #URL(String, String, String)
 *          construct} or {@linkplain #URL(String) parse} a {@code URL}
 *          from the direct string representation of a {@code File} or
 *          {@code Path}
 *          instance.
 *          <p>
 ...
 * @since 1.0
 */
public final class CustomURL implements java.io.Serializable {
     ...
     *                               {@code null},
     *                               or the parsed URL fails to comply with the
     *                               specific syntax
     ...
     * calling {@linkplain java.net.URLConnection#connect()
     ...
     *                                       and the caller doesn't have permission
     *                                       to connect
     *                                       to the proxy.
     ...
     *                                       implements the protocol handler doesn't
     *                                       support
     *                                       this method.
     * @see java.net.URL#URL(java.lang.String, java.lang.String,
     *      int, java.lang.String)
     ...
     *
     * @serialField file      String the specified file name on that host.
     *                        {@code file} is
     *                        defined as {@code path[?query]}
     *
