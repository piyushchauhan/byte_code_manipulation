 ...
 * @since 1.1
 */
public abstract class CustomHttpUrlConnection extends CustomerURLConnection {
    /* instance variables */
     ...
     * server. In this case, {@link #getHeaderField(int) getHeaderField(0)} returns
     * the status
     ...
     *
     * @throws IllegalStateException    if URLConnection is already connected
     *                                  or if a different streaming mode is already
     *                                  enabled.
     *
     ...
     * @param u the URL
     */
    protected CustomHttpUrlConnection(URL u) {
        super(u);
    }
